...
import {beforeUrl, China, pageAnimation, tagAnimation} from '../common/animation';
...
export class DataTableComponent implements OnInit {
  ...
  mySelection: IMenu[];                                    //选择
  mySelectionId: IMenu;                                    //选择的Id
